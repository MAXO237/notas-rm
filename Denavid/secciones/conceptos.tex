...
\begin{miDefinicion}{Eslabón base}
    ...
    \centering
    \includegraphics[width=0.45\textwidth]{imagenes/eslabon-base.png}
\end{miDefinicion}
...
\begin{miDefinicion}{Efector final}
    ...
    \centering
    \includegraphics[width=0.45\textwidth]{imagenes/efector-final.jpeg}
\end{miDefinicion}
...
\begin{miDefinicion}{Indexado de eslabones y articulaciones}
    ...
    \centering
    \includegraphics[width=0.45\textwidth]{imagenes/brazo-indexado.png}
\end{miDefinicion}
...
\begin{miDefinicion}{Articulación revoluta}
    ...
    \centering
    \includegraphics[width=0.45\textwidth]{imagenes/art-rev-prism.png}
\end{miDefinicion}
