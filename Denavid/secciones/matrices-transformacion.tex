...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.55\textwidth]{imagenes/transformacion-ejes.png}
        \caption{Dos marcos de referencia.}
        \label{fig:transformacion-ejes}
\end{figure}

Primero, D-H nos indica que rotemos el marco $i$ alrededor del eje $x_i$ para alinear el eje $z_i$ con el eje $z_{i-1}$. Definimos $\beta_i$ como el ángulo de rotación alrededor del eje $x_i$. El marco $i$ \textbf{rotado} lo definiremos como marco $i'$ como se muestra en la figura~\ref{fig:prueba1}.

\begin{figure}[H]
        \centering
        \includegraphics[width=0.55\textwidth]{imagenes/transformacion-ejes-i-prima.png}
        \caption{Primera rotación de marco de referencia.}
        \label{fig:prueba1}
\end{figure}

Luego, realizaremos una traslación a lo largo del eje $x_i$ para pasar del plano $P_i$ al plano $P_{i-1}$, es decir, colocaremos los origenes sobre el mismo plano. A esta translación o desplazamiento lineal la definiremos como $b_i$. Procedemos a definir al marco $i$ \textbf{rotado} y \textbf{trasladado} como el marco $k$. Este paso se muestra en la figura~\ref{fig:prueba2}.

\begin{figure}[H]
        \centering
        \includegraphics[width=0.55\textwidth]{imagenes/transformacion-ejes-k.png}
        \caption{Primera traslación de marco de referencia.}
        \label{fig:prueba2}
\end{figure}
...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.55\textwidth]{imagenes/transformacion-ejes-k-prima.png}
        \caption{Segunda rotación de marco de referencia.}
        \label{fig:prueba3}
\end{figure}
...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.55\textwidth]{imagenes/transformacion-ejes-final.png}
        \caption{Segunda Traslación de marco de referencia.}
        \label{fig:prueba4}
\end{figure}
